...
class ProgramNode extends ASTnode {
    ...
    public void nameAnalysis() {
        ...
        if (symTab.lookupGlobal("main") == null && !symTab.lookupGlobal("main").getType().isFnType()) {
            ErrMsg.fatal(0, 0, "No main function");
        }
    }
    
    public void codeGeneration() {
        myDeclList.codeGeneration();
    }
...
class FnBodyNode extends ASTnode {
    ...
    public void codeGeneration() {
        myStmtList.codeGeneration();
    }
    
    public int localSize() {
        return myDeclList.declSize();
    }
        ...
        if (!badDecl) {  // insert into symbol table
            try {
                if (myType instanceof StructNode) {
                    ...
                    sym.setOffset(symTab.getSize() - 1);
                }
...
class FnDeclNode extends DeclNode {
    ...
    public Sym nameAnalysis(SymTable symTab) {
        ...
        this.param = ((FnSym)myId.sym()).getNumParams();
        this.local = myBody.localSize();
    ...
    public void codeGeneration(){
        ...
        Codegen.generate("subu", Codegen.SP, Codegen.SP, 8 + (param * 4));
        Codegen.generate("addu", Codegen.FP, Codegen.SP, local * 4);

        myBody.codeGeneration();
        Codegen.genLabel("_" + myId.name() + "_exit");
        
        Codegen.generateIndexed("lw", Codegen.RA, Codegen.FP, -(param * 4));
        Codegen.generate("move", Codegen.T0, Codegen.FP); 
        Codegen.generateIndexed("lw", Codegen.FP, Codegen.FP, -(param * 4) - 4);
...
class PostIncStmtNode extends StmtNode {
    ...
    public void codeGeneration() {
		    myExp.codeGeneration();
        Sym sym = ((IdNode) myExp).sym();
        if(sym.isGlobal()) {
			      Codegen.generate("la", Codegen.T0, "_" + ((IdNode) myExp).name());
		    } else {
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGeneration() {
		    ...
		    myExp.codeGeneration();
		    Codegen.genPop(Codegen.T0);
		    Codegen.generate("beqz", Codegen.T0, "0", ifLabel);
...
class IfElseStmtNode extends StmtNode {
    ...
    public void codeGeneration() {
		    ...
		    myThenStmtList.codeGeneration();
		    Codegen.generate("b", elseLabel);
		    Codegen.genLabel(ifLabel);
		    myElseStmtList.codeGeneration();
...
class WhileStmtNode extends StmtNode {
    ...
    public void codeGeneration() {
		    String firstLabel = Codegen.nextLabel();
		    String secondLabel = Codegen.nextLabel();
		    
        Codegen.genLabel(firstLabel);
		    myExp.codeGeneration();
		    Codegen.genPop(Codegen.T0);
		    Codegen.generate("beq", Codegen.T0, "0", secondLabel); 
		    myStmtList.codeGeneration();
		    Codegen.generate("j", firstLabel);
...
class AssignNode extends ExpNode {
    ...
    public void codeGeneration() {
        ...
        if (sym.isGlobal()) {
            Codegen.generate("la", Codegen.T0, "_" + ((IdNode) myLhs).name()); 
            Codegen.genPush(Codegen.T0);
        }
        else {
            Codegen.generateIndexed("la", Codegen.T0, Codegen.FP, -sym.getOffset()); 
...
class PlusNode extends ArithmeticExpNode {
    ...
    public void codeGeneration() {
        myExp1.codeGeneration();
        myExp2.codeGeneration();
...
class AndNode extends LogicalExpNode {
    ...
    public void Codegen() {
        ...
        Codegen.genPop(Codegen.T0);
        Codegen.generate("li", Codegen.T1, "0");
        Codegen.generate("beq", Codegen.T0, "0", FirstLabel);

        myExp2.codeGeneration();
        Codegen.generate("b", SecondLabel);
...
class OrNode extends LogicalExpNode {
    ...
    public void codeGeneration() {
        ...
        myExp1.codeGeneration();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("bne", Codegen.T0, "1", firstLabel);
